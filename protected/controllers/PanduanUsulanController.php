...
class PanduanUsulanController extends Controller
{
	/**
...
// Redirect output to a clientâ€™s web browser (Excel5)
	...
	{
		$model=new PanduanUsulan;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['PanduanUsulan']))
		{
			$model->attributes=$_POST['PanduanUsulan'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('PanduanUsulan');
	...
	{
		$model=new PanduanUsulan('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PanduanUsulan']))
			$model->attributes=$_GET['PanduanUsulan'];
	 ...
	 * @return PanduanUsulan the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=PanduanUsulan::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PanduanUsulan $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='panduan-usulan-form')
		{
