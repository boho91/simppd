...
class BottomUpController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BottomUp']))
		{
			$model->attributes=$_POST['BottomUp'];
			if($model->save())
	 ...
	 * @return BottomUp the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=BottomUp::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param BottomUp $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bottom-up-form')
		{
