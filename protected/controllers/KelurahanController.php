...
'actions'=>array('admin','delete','drowdown_kelurahan'),
'users'=>array('@'),
),
...
public function actiondrowdown_kelurahan()
{
	$criteria = new CDbCriteria();
	$criteria->condition = "kecamatan = '".$_POST['kecamatan']."' ";
	$criteria->order = "kelurahan";
//	echo "kd_bidang = '".$_POST['kd_bidang']."' AND kd_urusan = '".$_POST['kd_urusan']."'";
	$data=Kelurahan::model()->findAll($criteria);
	
 	echo "<option value=''>--Pilih Kelurahan--</option>";
	$data=CHtml::listData($data,'id','kelurahan');
