...
<p class="help-block">Fields with <span class="required">*</span> are required.</p>
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'tahun'); ?> 
				<select required  name="KegiatanMusrenbang[tahun]"  id="tahun" class="form-control">
					<?php 
	...
	<div class='col-md-4'>
		...
		<?php echo $form->dropdownList($model,'kecamatan',CHtml::listData(Kecamatan::model()->findAll(array('order'=>'kecamatan')),
								'id','kecamatan'),
...
<div class="form-actions col-md-12">
	...
	<?php  $this->widget('booster.widgets.TbButton', array(
			...
			'url'=>'index.php?r=kegiatanMusrenbang/CetakUsulanPdf&tahun='.$tahun.'&kecamatan='.$kecamatan.'&kd_urusan='.$kd_urusan.''
		));  ?>
</div>
