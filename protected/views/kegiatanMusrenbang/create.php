...
$this->widget(
    ...
    array(
        'links' => array('Usulan Musrenbang'=> array('admin'),
        'Tambah Data',
),
...
$this->menu=array(
//array('label'=>'List KegiatanMusrenbang','url'=>array('index'),'buttonType'=> 'link','context' => 'danger',),
array('label'=>'Data Usulan Musrenbang','url'=>array('admin','skpd'=>$model->kd_skpd),'buttonType'=> 'link','context' => 'info',),
);
?>
<section class="content-header">
<h1>Form Usulan Musrenbang</h1>
</section>
...
<div class="col-md-10">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username">Usulan Kegiatan Musrenbang Kecamatan</h3>
