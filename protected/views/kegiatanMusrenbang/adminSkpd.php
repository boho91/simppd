...
array('label'=>'Tambah Usulan Musrenbang Kecamatan','url'=>array('create'),'buttonType'=> 'link','context' => 'success','htmlOptions'=>array('id'=>'btn_tambah')),
...
array('label'=>'Cetak Usulan','url'=>array('usulanPdf'),'buttonType'=> 'link','context' => 'success'),
array('label'=>'Export Usulan','url'=>array('usulanExcel'),'buttonType'=> 'link','context' => 'danger'),
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'kd_skpd',
			 'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("kegiatanMusrenbang/admin",array("skpd"=>$data->kd_skpd)))',
