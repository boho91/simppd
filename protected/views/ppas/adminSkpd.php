...
$this->widget(
    ...
    array(
        'links' => array('Data PPAS'),
		
    )
);
$this->menu=array(
//array('label'=>'List KegiatanMusrenbang','url'=>array('index')),
array('label'=>'Tambah PPAS','url'=>array('create'),'buttonType'=> 'link','context' => 'success','htmlOptions'=>array('id'=>'btn_tambah')),
...
$('#btn_tambah').click(function(){
	waitingDialog.show();
	$.post('index.php?r=ppas/modalForm',function(evt){
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'skpd',
			 'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("ppas/admin",array("skpd"=>$data->skpd)))',
