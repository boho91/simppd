<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'action'=>array('renja/verifikasi','id'=>$model->id)
)); ?>
...
";
 ?>
	...
	<?php echo $form->textAreaGroup($model,'alasan_tolak_renja', array('widgetOptions'=>array('htmlOptions'=>array('id'=>'txtAlasan','rows'=>1, 'cols'=>50, 'class'=>'span8')))); ?>
	</div>
