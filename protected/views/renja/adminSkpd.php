...
$this->widget(
    ...
    array(
        'links' => array('Kegiatan Renja'),
		
    )
);
$this->menu=array(
//array('label'=>'List KegiatanMusrenbang','url'=>array('index')),
array('label'=>'Tambah Data Renja','url'=>array('create'),'buttonType'=> 'link','context' => 'success','htmlOptions'=>array('id'=>'btn_tambah')),
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'skpd',
			'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("renja/admin",array("skpd"=>$data->skpd)))',
