...
$this->menu=array(
	...
	array('label'=>'Update Politis', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Politis', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage Politis', 'url'=>array('admin')),
);
?>

<h1>View Politis #<?php echo $model->id; ?></h1>
