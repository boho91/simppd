...
$this->widget(
    ...
    array(
        'links' => array('Data RKA Perubahan'),
...
$('#btn_tambah').click(function(){
	waitingDialog.show();
	$.post('index.php?r=rkaPerubahan/modalForm',function(evt){
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'skpd',
			 'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("rkaPerubahan/admin",array("skpd"=>$data->skpd)))',
