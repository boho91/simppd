...
$this->widget(
    ...
    array(
        'links' => array('RKA Perubahan'),
		
    )
);
$this->menu=array(
//array('label'=>'List Rka','url'=>array('index')),
array('label'=>'Tambah RKA Perubahan','url'=>array('create'),'buttonType'=> 'link','context' => 'info','htmlOptions'=>array('id'=>'btn_tambah')),
);

Yii::app()->clientScript->registerScript('search', "
$('#btn_tambah').click(function(){
		waitingDialog.show();
		$.post('index.php?r=rkaPerubahan/modalForm&skpd=".$model->skpd."',function(evt){
	...
	<div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Alokasi Anggaran </h3>
				...
				<td>
					...
					'booster.widgets.TbEditableField',
						array(
							...
							'url' => $this->createUrl('rkaPerubahan/gridUpdate'),
			...
			<tr>
				...
				<?php 
					...
					array(
						'type' => 'text',
						'model' => $data,
						'attribute' => 'pagu_prakiraan_maju', // $model->name will be editable
						'url' => $this->createUrl('rkaPerubahan/gridUpdate'),
							//'htmlOptions'=>array('title'=>'Contoh 10,000,000'),
						'name'=>"pagu_prakiraan_maju",
						'value' => 'CHtml::encode(number_format($data->pagu_prakiraan_maju))',
						'inputclass' => 'col-md-3 ',
						'options' => array(
						'placement' => 'top',
						'success' => 'js: function(data) {
			...
			<tr>
				...
				<?php 
					...
					array(
						'type' => 'text',
						'model' => $data,
						'attribute' => 'lokasi_kegiatan', // $model->name will be editable
					...
					array(
					   // 'name' => 'parent_id',
						...
						'value'=>function($data){
							...
							{
								echo '<a id="tambah_sub_uraian" data-original-title="Tambah Sub Uraian" class="view" title="" data-toggle="tooltip" href="index.php?r=rkaPerubahan/tambahSubUraian&parent_id='.$data->id.'"><i class="glyphicon glyphicon-plus"></i></a>';
							}else if($data->level=="sub uraian")
							{
								echo '<a id="tambah_item" data-original-title="Tambah Item" class="view" title="" data-toggle="tooltip" href="index.php?r=rkaPerubahan/tambahItem&parent_id='.$data->id.'"><i class="glyphicon glyphicon-plus"></i></a>';
							}
						},
					),
					array(
