...
'columns'=>array(
	array(
		...
		array(
			...
			'filter'=>'',
			'name'=>'program',
			'value' => 'CHtml::link($data[nama_program], Yii::app()->createUrl("RealisasiFisikDanKeuanganDakDpa/adminKegiatan",array("skpd"=>$data[skpd],"urusan"=>$data[urusan],"bidang"=>$data[bidang],"program"=>$data[program])))',
		),
