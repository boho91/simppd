...
$this->widget(
    ...
    array(
        'links' => array('Data DPA Perubahan'),
...
$('#btn_tambah').click(function(){
	waitingDialog.show();
	$.post('index.php?r=dpaPerubahan/modalForm',function(evt){
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'skpd',
			 'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("dpaPerubahan/admin",array("skpd"=>$data->skpd)))',
