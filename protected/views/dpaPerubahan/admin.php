...
$this->widget(
    ...
    array(
        'links' => array('DPA Perubahan'),
		
    )
);
$this->menu=array(
//array('label'=>'List Rka','url'=>array('index')),
array('label'=>'Tambah DPA Perubahan','url'=>array('create'),'buttonType'=> 'link','context' => 'info','htmlOptions'=>array('id'=>'btn_tambah')),
);

Yii::app()->clientScript->registerScript('search', "
$('#btn_tambah').click(function(){
		waitingDialog.show();
		$.post('index.php?r=dpaPerubahan/modalForm&skpd=".$model->skpd."',function(evt){
...
<?php
	...
	if($dataProvider->itemCount>0)
	{
		...
		<div class="box-header">
			<h3 class="box-title">Alokasi Anggaran pada DPA  Perubahan SKPD </h3>
				...
				<td>
					...
					'booster.widgets.TbEditableField',
						array(
							...
							'url' => $this->createUrl('dpaPerubahan/gridUpdate'),
					...
					array(
					   // 'name' => 'parent_id',
						...
						'value'=>function($data){
							...
							{
								echo '<a id="tambah_sub_uraian" data-original-title="Tambah Sub Uraian" class="view" title="" data-toggle="tooltip" href="index.php?r=dpaPerubahan/tambahSubUraian&parent_id='.$data->id.'"><i class="glyphicon glyphicon-plus"></i></a>';
							}else if($data->level=="sub uraian")
							{
								echo '<a id="tambah_item" data-original-title="Tambah Item" class="view" title="" data-toggle="tooltip" href="index.php?r=dpaPerubahan/tambahItem&parent_id='.$data->id.'"><i class="glyphicon glyphicon-plus"></i></a>';
							}
						},
					),
					array(
