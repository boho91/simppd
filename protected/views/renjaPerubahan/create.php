...
$this->menu=array(
//array('label'=>'List Renja','url'=>array('index'),'buttonType'=> 'link','context' => 'danger',),
...
<div class="col-md-10">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username">Rencana Program dan Kegiatan Renja</h3>
	...
	<div class='clear'></div>
<?php echo $this->renderPartial('_form', array('model'=>$model,'renja'=>$renja)); ?></section>