...
$this->widget(
    ...
    array(
        'links' => array('Kegiatan Renja Perubahan'),
		
    )
);
$this->menu=array(
//array('label'=>'List KegiatanMusrenbang','url'=>array('index')),
array('label'=>'Tambah Data Renja Perubahan','url'=>array('create'),'buttonType'=> 'link','context' => 'info','htmlOptions'=>array('id'=>'btn_tambah')),
array('label'=>'Cetak Usulan','url'=>array('usulanPdf'),'buttonType'=> 'link','context' => 'danger'),
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'skpd',
			'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("renjaPerubahan/admin",array("skpd"=>$data->skpd)))',
