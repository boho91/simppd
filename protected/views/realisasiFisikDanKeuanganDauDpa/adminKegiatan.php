...
'columns'=>array(
	array(
		...
		array(
			...
			'filter'=>'',
			'name'=>'kegiatan',
			'value' => 'CHtml::link($data[nama_kegiatan], Yii::app()->createUrl("RealisasiFisikDanKeuanganDauDpa/evaluasiKegiatan",array("skpd"=>$data[skpd],"urusan"=>$data[urusan],"bidang"=>$data[bidang],"program"=>$data[program],"kegiatan"=>$data[kegiatan])))',
		),
