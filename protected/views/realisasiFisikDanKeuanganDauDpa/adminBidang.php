...
'columns'=>array(
	array(
		...
		array(
			...
			'filter'=>'',
			'name'=>'bidang',
			'value' => 'CHtml::link($data[nama_bidang], Yii::app()->createUrl("RealisasiFisikDanKeuanganDauDpa/adminProgram",array("skpd"=>$data[skpd],"urusan"=>$data[urusan],"bidang"=>$data[bidang])))',
		),
