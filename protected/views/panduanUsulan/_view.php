...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('jenis_usulan')); ?>:</b>
	<?php echo CHtml::encode($data->jenis_usulan); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('nama_usulan')); ?>:</b>
	<?php echo CHtml::encode($data->nama_usulan); ?>
	<br />
