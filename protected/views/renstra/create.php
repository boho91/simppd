...
$this->widget(
    ...
    array(
        'links' => array('Renstra'=> array('admin'),
        'Tambah Data',
),
...
$this->menu=array(
//array('label'=>'List Renstra','url'=>array('index'),'buttonType'=> 'link','context' => 'danger',),
...
<div class="col-md-10">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username">Rencana Program dan Kegiatan Renstra</h3>
              <h5 class="widget-user-desc"><?php echo $model->skpd_->nama_skpd?></h5>
            </div>
            <div class="widget-user-image">
              Tahun <?php echo $model->tahun_perencanaan?>
            </div>
