...
'columns'=>array(
	array(
		...
		array(
			...
			'filter'=>'',
			'name'=>'program',
			'value' => 'CHtml::link($data->kegiatan_->program_->program, Yii::app()->createUrl("evaluasiRenja/adminKegiatan",array("skpd"=>$data->skpd,"urusan"=>$data->urusan,"bidang"=>$data->bidang,"program"=>$data->program)))',
		),
		array(
			'class'=>'CDataColumn',
			'htmlOptions'=>array('width'=>150),
