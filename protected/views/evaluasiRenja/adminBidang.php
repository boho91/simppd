...
'columns'=>array(
	array(
		...
		array(
			...
			'filter'=>'',
			'name'=>'bidang',
			'value' => 'CHtml::link($data->kegiatan_->program_->bidang_->bidang, Yii::app()->createUrl("evaluasiRenja/adminProgram",array("skpd"=>$data->skpd,"urusan"=>$data->urusan,"bidang"=>$data->bidang)))',
		),
		array(
			'class'=>'CDataColumn',
			'htmlOptions'=>array('width'=>150),
