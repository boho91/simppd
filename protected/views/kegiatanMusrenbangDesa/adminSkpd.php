...
array('label'=>'Tambah Usulan Musrenbang Kelurahan','url'=>array('create'),'buttonType'=> 'link','context' => 'success','htmlOptions'=>array('id'=>'btn_tambah')),
...
$('#btn_tambah').click(function(){
	waitingDialog.show();
	$.post('index.php?r=kegiatanMusrenbangDesa/modalForm',function(evt){
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'kd_skpd',
			 'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("kegiatanMusrenbangDesa/admin",array("skpd"=>$data->kd_skpd)))',
