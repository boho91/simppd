...
<p class="help-block">Fields with <span class="required">*</span> are required.</p>
	...
	<div class='col-md-4'>
		...
		<?php echo $form->dropdownList($model,'desa',CHtml::listData(Desa::model()->findAll(array('order'=>'desa')),
								'id','desa'),
...
<div class="form-actions col-md-12">
	<?php  $this->widget('booster.widgets.TbButton', array(
			...
			'url'=>'index.php?r=kegiatanMusrenbangDesa/CetakUsulanExcel&tahun='.$tahun.'&kd_urusan='.$kd_urusan.'&desa='.$desa.''
		)); ?>
