...
$('#btn_tambah').click(function(){
		waitingDialog.show();
		$.post('index.php?r=rka/modalForm&skpd=".$model->skpd."',function(evt){
					...
					array(
					   // 'name' => 'parent_id',
						...
						'value'=>function($data){
							...
							{
								echo '<a id="tambah_sub_uraian" data-original-title="Tambah Sub Uraian" class="view" title="" data-toggle="tooltip" href="index.php?r=rka/tambahSubUraian&parent_id='.$data->id.'"><i class="glyphicon glyphicon-plus"></i></a>';
							}else if($data->level=="sub uraian")
							{
								echo '<a id="tambah_item" data-original-title="Tambah Item" class="view" title="" data-toggle="tooltip" href="index.php?r=rka/tambahItem&parent_id='.$data->id.'"><i class="glyphicon glyphicon-plus"></i></a>';
							}
						},
					),
					array(
