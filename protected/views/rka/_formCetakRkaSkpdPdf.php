...
<?php echo $form->errorSummary($model); ?>
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'tahun'); ?> 
				<select required  name="Rka[tahun]"  id="tahun" class="form-control">
					<?php 
...
<div class="form-actions">
	<?php $this->widget('booster.widgets.TbButton', array(
			'buttonType'=>'submit',
			'context'=>'primary',
			'label'=>$model->isNewRecord ? 'Cetak Pdf' : 'Cetak',
			'url'=>'index.php?r=rka/CetakPdf&tahun='.$tahun.'&urusan='.$urusan.'&skpd='.$skpd.''
		)); ?>
</div>
