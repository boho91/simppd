<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	'id'=>'pokok-pikiran-dprd-form',
	'enableAjaxValidation'=>false,
	'action'=>array('pokokpikirandprd/create')
)); ?>
...
echo $form->errorSummary($model); ?>
	...
	}else
	{
		...
		<?php echo $form->dropdownList($model,'kd_skpd',CHtml::listData(Skpd::model()->findAll(array('order'=>'nama_skpd')),
		 ...
		 ?> 
		<?php echo $form->hiddenField($model,'kd_skpd',array('id'=>'skpd')); ?>
		</div>
		</div>
		<?php
	}
	...
	if(Yii::app()->user->isAdminBappeda())
	{
		...
		<?php echo $form->dropdownList($model,'kd_prog',CHtml::listData(KegiatanSkpd::model()->findAll(array('group'=>'program')),
	...
	}else
	{
		...
		<div class='form-group'>
		<?php echo $form->labelEx($model,'kd_prog'); ?> 
		<?php echo $form->dropdownList($model,'kd_prog',CHtml::listData(KegiatanSkpd::model()->findAll(array('condition'=>'skpd="'.$model->skpd.'"','group'=>'program')),
								'program','nama_program'),
								array(
								'id'=>'program',
								'class'=>'form-control',
	...
	<?php echo $form->dropdownList($model,'kd_kegiatan',CHtml::listData(Kegiatan::model()->findAll(array('order'=>'kegiatan')),
                            'id','namaKegiatan'),
