...
$this->widget(
    ...
    array(
        'links' => array('Usulan Pokok Pikiran DPRD'=> array('admin'),
        'Lihat Data',),		
    )
);
...
array('label'=>'Edit Usulan Pokok Pikiran DPRD','url'=>array('update','id'=>$model->id),'buttonType'=> 'link','context' => 'warning',),
...
array('label'=>'Data Usulan Pokok Pikiran DPRD','url'=>array('adminSkpd','skpd'=>$model->kd_skpd),'buttonType'=> 'link','context' => 'info',),
);
?>
<section class="content-header">
<h1>View Usulan Pokok Pikiran DPRD</h1>
</section>
