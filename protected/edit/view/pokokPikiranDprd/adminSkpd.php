...
array('label'=>'Tambah Usulan Pokok Pikiran DPRD','url'=>array('create'),'buttonType'=> 'link','context' => 'success'),
array('label'=>'Cetak Plafon','url'=>array('plafonPdf'),'buttonType'=> 'link','context' => 'info'),
array('label'=>'Export Plafon','url'=>array('plafonExcel'),'buttonType'=> 'link','context' => 'warning'),
array('label'=>'Cetak Usulan Pokok Pikiran DPRD','url'=>array('usulanPdf'),'buttonType'=> 'link','context' => 'success'),
array('label'=>'Export Usulan Pokok Pikiran DPRD','url'=>array('usulanExcel'),'buttonType'=> 'link','context' => 'danger'),
...
$.fn.yiiGridView.update('pokok-pikiran-grid', {
data: $(this).serialize()
});
return false;
});
...
<h1>Data Usulan Pokok Pikiran DPRD</h1>
...
'columns'=>array(
	array(
		...
		array(
			...
			'type'=>'raw',
			'name'=>'kd_skpd',
			 'value' => 'CHtml::link($data->skpd_->nama_skpd, Yii::app()->createUrl("pokokpikirandprd/admin",array("skpd"=>$data->kd_skpd)))',
