 ...
 */
class PokokPikiranDprd extends CActiveRecord
{
	/**
	...
	public function totalPaguPerBidang($tahun,$bidang)
	{
		$criteria = new CDbCriteria;
		$criteria->condition='tahun="'.$tahun.'"  AND kd_bidang ="'.$bidang.'"';
	...
	public function totalPaguPerProgram($tahun,$bidang,$program)
	{
		$criteria = new CDbCriteria;
		$criteria->condition='tahun="'.$tahun.'" AND kd_bidang ="'.$bidang.'" AND kd_prog = "'.$program.'"';
		$criteria->group = "kd_bidang";
		$criteria->select = "SUM(pagu_tahun_1) as pagu_tahun_1,SUM(pagu_tahun_2) as pagu_tahun_2";
		$model = $this->find($criteria);
		$model->pagu_tahun_1 = $model->pagu_tahun_1*1;
