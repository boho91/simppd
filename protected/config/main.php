...
//                'ext.giiplus', 
    ...
    'components' => array(
			...
			'params'        => array(
				...
				'HTML2PDF' => array(
					...
					'defaultParams'     => array( // More info: http://wiki.spipu.net/doku.php?id=html2pdf:en:v4:accueil
						...
						'marges'      => array(12,15,12,12), // margins by default, in order (left, top, right, bottom)
					)
				)
			),
		),
        ...
        // uncomment the following to use a MySQL database
          ...
          'db'=>array(
          'connectionString' => 'mysql:host=localhost;dbname=db_sippd',
    ...
    'params' => array(
		...
		'application_nickname'=>'SIMPEPEDA',
