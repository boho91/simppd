...
/**
 * This is the model class for table "teknokratis".
 *
 * The followings are the available columns in table 'teknokratis':
 * @property string $id
 ...
 */
class Teknokratis extends CActiveRecord
{
	/**
	 ...
	 * @return Teknokratis the static model class
	 */
