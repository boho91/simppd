 ...
 */
class KegiatanMusrenbangDesa extends CActiveRecord
{
	/**
	...
	public function totalPaguPerBidangDesa($tahun,$desa,$bidang)
	{
		$criteria = new CDbCriteria;
		$criteria->condition='tahun="'.$tahun.'" AND desa="'.$desa.'" AND kd_bidang ="'.$bidang.'"';
	...
	public function totalPaguPerProgramDesa($tahun,$desa,$bidang,$program)
	{
		$criteria = new CDbCriteria;
		$criteria->condition='tahun="'.$tahun.'" AND desa="'.$desa.'" AND kd_bidang ="'.$bidang.'" AND kd_prog = "'.$program.'"';
		$criteria->group = "kd_bidang";
		$criteria->select = "SUM(pagu_tahun_1) as pagu_tahun_1,SUM(pagu_tahun_2) as pagu_tahun_2";
		$model = $this->find($criteria);
		$model->pagu_tahun_1 = $model->pagu_tahun_1*1;
	...
	{
		return 'kegiatan_musrenbang_desa';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('kd_skpd, kd_urusan, kd_bidang,desa,sumber_dana, kd_prog,pagu_tahun_2, tahun, kunci', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'desa_'=>array(self::BELONGS_TO, 'Desa', 'desa'),
