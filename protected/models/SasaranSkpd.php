...
/**
 * This is the model class for table "sasaran_skpd".
 *
 * The followings are the available columns in table 'sasaran_skpd':
 * @property string $id
 ...
 */
class SasaranSkpd extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('tujuan, sasaran, skpd', 'required'),
			array('tujuan, skpd', 'numerical', 'integerOnly'=>true),
			array('sasaran', 'length', 'max'=>300),
			array('created_by, mod_by', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tujuan, sasaran, skpd, created_date, created_by, mod_date, mod_by', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SasaranSkpd the static model class
	 */
