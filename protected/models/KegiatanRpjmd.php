...
/**
 * This is the model class for table "kegiatan_rpjmd".
 *
 * The followings are the available columns in table 'kegiatan_rpjmd':
 * @property string $id
 ...
 */
class KegiatanRpjmd extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('urusan, bidang, program, kegiatan, skpd,target_tahun1,target_tahun2,target_tahun3,target_tahun4,target_tahun5,  id_rpjmd', 'numerical', 'integerOnly'=>true),
			array('kondisi_kinerja_awal,created_by,created_date,mod_by,mod_date,indikator_kinerja,target_akhir,satuan_target_kinerja', 'length', 'max'=>255),
			array('dana_tahun1, dana_tahun2, dana_tahun3, dana_tahun4, dana_tahun5, dana_akhir', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, urusan, bidang, program, kegiatan, skpd,  indikator_kinerja, kondisi_kinerja_awal, id_rpjmd, target_tahun1, dana_tahun1, target_tahun2, dana_tahun2, target_tahun3, dana_tahun3, target_tahun4, dana_tahun4, target_tahun5, dana_tahun5, target_akhir, dana_akhir', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'rpjmd'=>array(self::BELONGS_TO, 'Rpjmd', 'id_rpjmd'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_rpjmd' => 'Tahun Rpjmd',
			'target_tahun1' => 'Target Tahun-1',
			'dana_tahun1' => 'Pagu Tahun-1',
			'target_tahun2' => 'Target Tahun-2',
			'dana_tahun2' => 'Pagu Tahun-2',
			'target_tahun3' => 'Target Tahun-3',
			'dana_tahun3' => 'Pagu Tahun-3',
			'target_tahun4' => 'Target Tahun-4',
			'dana_tahun4' => 'Pagu Tahun-4',
			'target_tahun5' => 'Target Tahun-5',
			'pagu1'=>'Pagu Tahun-1',
			'pagu2'=>'Pagu Tahun-2',
			'pagu3'=>'Pagu Tahun-3',
			'pagu4'=>'Pagu Tahun-4',
	 ...
	 * @return KegiatanRpjmd the static model class
	 */
