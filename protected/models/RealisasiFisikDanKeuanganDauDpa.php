...
{
	public $jenis_dpa,$uraian,$manfaat_kegiatan,$persentase_keuangan;
	...
	public function realisasiKeuanganTertinggi($tahun="",$bulan="")
	{
		...
		$command = Yii::app()->db->createCommand()
			...
			->from('(SELECT skpd,ROUND((SUM(realisasi_keuangan) /SUM(harga_satuan*volume))*100,2) as persentase_keuangan FROM realisasi_fisik_dan_keuangan_dau_dpa WHERE bulan="'.$bulan.'" AND tahun="'.$tahun.'"  GROUP BY skpd,kegiatan) as t ');
