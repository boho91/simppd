...
/**
 * This is the model class for table "tujuan_skpd".
 *
 * The followings are the available columns in table 'tujuan_skpd':
 * @property string $id
 ...
 */
class TujuanSkpd extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('tujuan, skpd', 'required'),
			array('skpd', 'numerical', 'integerOnly'=>true),
			array('tujuan', 'length', 'max'=>300),
			array('created_by, mod_by', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tujuan, skpd, created_date, created_by, mod_date, mod_by', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TujuanSkpd the static model class
	 */
