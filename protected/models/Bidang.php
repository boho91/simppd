...
class Bidang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('urusan, kode_bidang, bidang', 'required'),
			array('urusan', 'numerical', 'integerOnly'=>true),
			array('kode_bidang, bidang, created_by, mod_by', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, urusan, kode_bidang, bidang, created_by, created_date, mod_by, mod_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('kode_bidang',$this->kode_bidang,true);
