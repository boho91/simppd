 ...
 */
class Rka extends CActiveRecord
{
	...
	public function harga_satuan_parent4($id)
	{
		...
		$criteria->join = "LEFT JOIN rka c ON t.id = c.parent_id LEFT JOIN rka d ON c.id = d.parent_id  LEFT JOIN rka e ON d.id = e.parent_id ";
	...
	public function harga_satuan_parent3($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN rka c ON t.id = c.parent_id LEFT JOIN rka d ON c.id = d.parent_id  LEFT JOIN rka e ON d.id = e.parent_id  LEFT JOIN rka f ON e.id = f.parent_id ";
	...
	public function harga_satuan_parent2($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN rka c ON t.id = c.parent_id LEFT JOIN rka d ON c.id = d.parent_id  LEFT JOIN rka e ON d.id = e.parent_id  LEFT JOIN rka f ON e.id = f.parent_id  LEFT JOIN rka g ON f.id = g.parent_id ";
	...
	public function harga_satuan_parent1($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN rka c ON t.id = c.parent_id LEFT JOIN rka d ON c.id = d.parent_id  LEFT JOIN rka e ON d.id = e.parent_id  LEFT JOIN rka f ON e.id = f.parent_id  LEFT JOIN rka g ON f.id = g.parent_id   LEFT JOIN rka h ON g.id = h.parent_id ";
	...
	public function getPaguTotalPerTahun($tahun)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "tahun = '".$tahun."'";
		$criteria->select = "SUM(volume*harga_satuan) as totalPerKegiatan";
	...
	public function harga_satuan_per_uraian($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN rka c ON t.id = c.parent_id LEFT JOIN rka d ON c.id = d.parent_id";
	...
	public function rules()
	{
		...
		return array(
			...
			array('tahun, urusan, bidang, program, kegiatan, skpd,pagu_prakiraan_maju, parent_id, parentCategory, volume', 'numerical', 'integerOnly'=>true),
