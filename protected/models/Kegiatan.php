...
class Kegiatan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('program, kode_kegiatan, kegiatan', 'required'),
			array('program', 'length', 'max'=>20),
			array('kode_kegiatan, created_by, mod_by', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, program, kode_kegiatan, kegiatan, created_by, created_date, mod_by, mod_date', 'safe', 'on'=>'search'),
		);
	}
