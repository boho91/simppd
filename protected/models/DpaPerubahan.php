 ...
 */
class DpaPerubahan extends CActiveRecord
{
	
	public $pagu1,$nama_program,$nama_kegiatan,$totalPerUraian,$totalPerSubUraian,$totalPerItem,$alokasiAnggaran,$uraianKegiatan,$harga_satuan_kegiatan,$totalPerKegiatan;
	...
	public function harga_satuan_parent4($id)
	{
		...
		$criteria->join = "LEFT JOIN dpa_perubahan c ON t.id = c.parent_id LEFT JOIN dpa_perubahan d ON c.id = d.parent_id  LEFT JOIN dpa_perubahan e ON d.id = e.parent_id ";
	...
	public function harga_satuan_parent3($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN dpa_perubahan c ON t.id = c.parent_id LEFT JOIN dpa_perubahan d ON c.id = d.parent_id  LEFT JOIN dpa_perubahan e ON d.id = e.parent_id  LEFT JOIN dpa_perubahan f ON e.id = f.parent_id ";
	...
	public function harga_satuan_parent2($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN dpa_perubahan c ON t.id = c.parent_id LEFT JOIN dpa_perubahan d ON c.id = d.parent_id  LEFT JOIN dpa_perubahan e ON d.id = e.parent_id  LEFT JOIN dpa_perubahan f ON e.id = f.parent_id  LEFT JOIN dpa_perubahan g ON f.id = g.parent_id ";
	...
	public function harga_satuan_parent1($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN dpa_perubahan c ON t.id = c.parent_id LEFT JOIN dpa_perubahan d ON c.id = d.parent_id  LEFT JOIN dpa_perubahan e ON d.id = e.parent_id  LEFT JOIN dpa_perubahan f ON e.id = f.parent_id  LEFT JOIN dpa_perubahan g ON f.id = g.parent_id   LEFT JOIN dpa_perubahan h ON g.id = h.parent_id ";
	...
	public function harga_satuan_per_uraian($id)
	{
		$criteria = new CDbCriteria;
		$criteria->condition = "d.id IS NOT NULL AND t.id = ".$id."";
		$criteria->join = "LEFT JOIN dpa_perubahan c ON t.id = c.parent_id LEFT JOIN dpa_perubahan d ON c.id = d.parent_id";
	...
	public function rules()
	{
		...
		return array(
			...
			array('harga_satuan,sub_uraian,item,jenis_sumber_dana,volume,satuan', 'length', 'max'=>200),
