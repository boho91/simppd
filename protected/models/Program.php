...
class Program extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('bidang, kode_program, program', 'required'),
			array('bidang', 'length', 'max'=>20),
			array('kode_program, created_by, mod_by', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, bidang, kode_program, program, created_by, created_date, mod_by, mod_date', 'safe', 'on'=>'search'),
		);
	}
