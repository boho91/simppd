...
/**
 * This is the model class for table "top_down".
 *
 * The followings are the available columns in table 'top_down':
 * @property string $id
 ...
 */
class TopDown extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, pagu_indikatif, pagu_prakiraan_maju', 'length', 'max'=>20),
	 ...
	 * @return TopDown the static model class
	 */
